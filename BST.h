...
struct BST {
		...
		bool display(int, int);	// fucntion (C)
		void ReverseinOrderPrint();// Function (C)
		void ReverseinOrderPrint2(BTNode*); // Function C
		void ReverseinOrderPrintOutFile(ofstream&); //Function (C)
		void ReverseinOrderPrint2OutFile(BTNode*, ofstream&); // Function C
		void inOrderPrintOutFile(ofstream&); // Function C
		void inOrderPrint2OutFile(BTNode*, ofstream&);

		//Clone subtree
		BTNode* Find(type);
		BTNode* Find2(BTNode*, type);
		bool CloneSubtree(BST*, type);
		void cloneSubtree2(BTNode* rootToClone, BST& t2);
